...
line_bot_api = LineBotApi('ZyyPaujm6SVEdPMCx0z7rakVO89dfunG8GTnQnay5CWyM10Ruv9FliTsrCCJ7YRzhfJSdZ4SgsnroshUPa3B415qGq36tkIYjtx98x2rZZGWTsHY0ahaOCs4eJjR8N+As7e2VZs2oGs4YRnA/X2dYgdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('7ac293416aabcfd82a660216ad4b6e42')
liffid = '1656742581-X9mM9J5p'

#LIFF靜態頁面
@app.route('/page')
def page():
	return render_template('index1223.html', liffid = liffid)
